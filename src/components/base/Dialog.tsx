...
export const Dialog: React.FC<DialogProps> = ({ isOpen, onClose, closeOnOverlayClick, children, className }) => {
    ...
    return (
        <div className={`fixed top-0 left-0 right-0 bottom-0 flex flex-col items-strech justify-center bg-black bg-opacity-50 ${className}`} onClick={closeOnOverlayClick ? onClose : undefined}>
